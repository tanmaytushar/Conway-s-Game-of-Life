...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(computeNextBoardGol, 100);
    return () => clearInterval(interval);
  }, [isPlaying, computeNextBoardGol]);
  ...
  // this has a different set of rules around being alive and dead
  // change Gols to seed function to 
